...
import { getPromotions, PromotionUrlEndpoint as cacheKey } from "@/services/PromotionService";
...
const PromotionComponent: React.FC<any> = (props: any) => {
    ...
    const { data, error, isLoading, mutate } = useSWR([cacheKey, options], () => getPromotions(options), {
